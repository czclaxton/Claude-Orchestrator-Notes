...
### 5. Personas / profiles — preset modes that change how the session communicates

**Status: not started, deliberately parked behind the current lessons-promotion backlog.** Recorded
